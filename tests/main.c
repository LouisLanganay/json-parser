...
Test(json_parser, Simple_Object) {
...
Test(json_parser, Two_Levels_Object) {
    parsed_data_t *data = jp_parse("tests.json");
...
Test(json_parser, Arr_Of_Int_In_Object) {
    parsed_data_t *data = jp_parse("tests.json");
...
Test(json_parser, Arr_Of_Object_In_Object) {
    parsed_data_t *data = jp_parse("tests.json");
